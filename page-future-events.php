<?php /* Template Name: Будущие мероприятия */?>
<?php get_header(); ?>
...
<div class="filter-popup">
    <div class="filter-popup__wrapp bg--dark-light">
        ...
        <div class="filter-popup__action center">
            <button  class="filter-popup__btn filter-popup__future-btn button button--blue">
                Применить фильтр
            </button>
        </div>
    </div>
...
<section class="events bg--dark block-padding">
    <div class="events__body container">
        ...
        ?>
        <div class="events__result events__result-future">
            <?php
